...
erDiagram
    ...
    barang_masuk {
        ...
        string nama_barang
        string nusp
        string spesifikasi_nama_barang
        integer jumlah
        bigint satuan_id FK
        string satuan_nama
        decimal harga_satuan
    ...
    permintaan_barang {
        ...
        enum prioritas "biasa|segera|sangat_segera"
        enum status "menunggu_admin|menunggu_user|disetujui|ditolak|selesai"
        text catatan
        string lampiran
        timestamp disetujui_admin_at
        bigint disetujui_admin_by FK
        timestamp disetujui_user_at
        timestamp ditolak_at
        text alasan_ditolak
        timestamp created_at
        timestamp updated_at
    }
    ...
    detail_permintaan_barang {
        bigint id PK
        bigint permintaan_barang_id FK
        string kode_barang
        string nama_barang
        text spesifikasi
        integer pengajuan_jumlah
        string satuan
        text keperluan
        integer disetujui_jumlah
        string disetujui_satuan
        enum status "menunggu|disetujui|disesuaikan"
        text catatan_admin
        timestamp created_at
        timestamp updated_at
    }
    ...
    pengeluaran_barang {
        bigint id PK
        bigint permintaan_barang_id FK
        bigint detail_permintaan_id FK
        bigint barang_id FK
        string kode_barang
        string nama_barang
        integer jumlah
    ...
    %% Relasi
    barang }o--|| kategori : "belongs to"
    barang }o--|| satuan : "belongs to"

    barang_masuk }o--o| barang : "references (nullable)"
    barang_masuk }o--o| satuan : "references (nullable)"
    barang_masuk }o--o| users : "created_by (nullable)"

    permintaan_barang }o--|| users : "diajukan oleh"
    permintaan_barang }o--o| users : "disetujui_admin_by (nullable)"

    detail_permintaan_barang }o--|| permintaan_barang : "bagian dari"

    pengeluaran_barang }o--|| permintaan_barang : "dari permintaan"
    pengeluaran_barang }o--|| detail_permintaan_barang : "dari detail"
    pengeluaran_barang }o--o| barang : "references (nullable)"
    pengeluaran_barang }o--|| users : "created_by"
```
